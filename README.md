    ...
    <header>
        <nav class="navbar">
            ...
            <nav class="navbarlinks">
                <a href="https://www.facebook.com/nox.edu" target="_blank"><img src="facebook.webp" alt="facebook"></a>
                <a href="https://www.instagram.com/nox.servicioseducativos/" target="_blank"><img
                        src="instagram_gde.webp" alt="instagram"> </a>
            </nav>
        </nav>
        <div id="logo">
            <a id="top"></a>
    ...
    <main>
        <div class="cabecera">
            <div class="cabeceratexto">
                <h1 style="font-size: 88px; font-weight: 900;">NOX</h1>
                <h2 style="font-size: 38px">Servicios lingüisticos y educativos
                </h2>
                <br>
                <a href="#perfiltexto" class="buttoncabecera">Leer más</a>
            </div>
        </div>
        <section id="perfil">
            <section id="perfiltexto">
                <h1 style="font-family:'Work Sans'; font-size: 65px;">Nuestro Perfil</h1>
                <br>
                <p style="font-family:'Work Sans'; font-size: 20px; font-weight: 100;">NOX - Servicios lingüísticos y
        ...
        <section id="servicios">
            <br>
            <br>
            <h1 style="font-family:Alata; text-align:center; color:#809fff; font-size: 80px; font-weight: 100;">
                Servicios profesionales</h1>
            <br>
            <br>
            <div class="container">
                <div class="slider">
        ...
        <section id="contacto">
            <form action="">
                ...
                <input type="button" value="Enviar" id="botonform">
            </form>
        
        </section>

    </main>
    <footer><p>©2020 by NOX - Servicios lingüísticos y educativos. Desarrollado por Matías Lloréns</p>
